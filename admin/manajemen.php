...
<div class="container">
    <div class="card">
            ...
            <h2 class="text-center">Tambah KELUAR MASUK BARANG DAN STOK AKHIR</h2>
            </div>
        <div class="card-body">
            <div class="card-body">
                <div class="row justify-content-center">
                    <form action="manajemen.php"  method="post" name="Submit">
                    <div class="d-flex ">
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered ">
                ...
                while($data = mysqli_fetch_array($hasil)) { 
                    ...
                    echo "<td>
                        <a href='manajemen_edit.php?id=$data[id_stok]'>Edit</a> | 
